...
-- Usage: SQL> @ash_sql_block_waits_temp 43kfr3uthbugg 2 500
-- by Igor Usoltsev
--
...
with ash as (select /* MATERIALIZE*/ * from ash_20150304_13
...
join ash ash2 on --ash1.current_file#  = ash2.current_file#
             --and ash1.current_block# = ash2.current_block# and
    ash1.current_obj# = 393
and ash1.current_obj# = ash2.current_obj#
...
where --ash1.wait_class    = 'Cluster' and                                         -- кластерные
--      ash1.p1text        = 'file#'   and                                              -- блок-ориентированные
   ash1.session_state = 'WAITING'                                             -- ожидания
