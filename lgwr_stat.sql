--
-- LGWT events and stat history
-- Usage: SQL> @lgwr_hist_stat [80300]        [80315]         [2]
--                             ^start snap_id ^finish snap_id ^instance number
--

break ON EVENT_NAME ON EVENT_NAME2
col EVENT_NAME for a23
col EVENT_NAME2 for a13
...
from dba_hist_system_event hse
     ...
     where snap_id between nvl('&1', snap_id) and nvl('&2', snap_id)
       and hse.event_name  = 'log file parallel write'
       and hse2.event_name = 'log file sync'
